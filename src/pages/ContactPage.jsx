    ...
    <div className="contact-page">
      <div className="contact-page__inner">
        ...
        <div className="contact-page__grid">
          ...
          <section className="contact-page__card"><MapPin size={22} /><h2>Company</h2><p>Alterity Labs Pvt Ltd.</p><p><strong>Company address</strong><br />1st Floor, 214/A Wing, ORM Premises Co-op Society, Aarey Milk Colony, Goregaon (East), Royal Palms, Nr. Unit No. 26, Mumbai 400065</p></section>
        </div>
